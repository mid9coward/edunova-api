...
`
  ...
  private getFallbackResponse(userMessage: string): ChatbotResponse {
    ...
    return {
      response:
        'Tôi là trợ lý AI của EDUNOVA Learning! 😊 Tôi có thể giúp bạn tìm khóa học, tư vấn lộ trình, hỗ trợ chính sách...\n\n📱 Liên hệ trực tiếp: @edu3nova trên Telegram hoặc gọi +84 978093224',
